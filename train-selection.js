...
const trains = [
    { id: 1, time: "08:00 AM", duration: "3h", price: 450 },
    { id: 2, time: "10:00 AM", duration: "3h", price: 550 },
    { id: 3, time: "12:00 PM", duration: "3h", price: 400 },
    { id: 4, time: "02:00 PM", duration: "3h", price: 700 },
    { id: 5, time: "04:00 PM", duration: "3h", price: 600 },
];
...
function renderTrains() {
    ...
    trains.forEach((train) => {
        ...
        trainInfo.innerHTML = `
            ...
            <p><b>Ticket Price: </b>Rs ${train.price}</p>
        `;
